...
import rawStyles from './HomepageCatalog.module.css';
...
function HomepageCatalog() {
  ...
  if (loading) {
    ...
    return <LoadingSpinner message="Loading equipment..." showTimer={false} />;
  }
      ...
      <section className={styles.heroSection}>
        <div className={styles.heroContent}>
          ...
          <div className={styles.heroLogo}>
            <img src={logo} alt="University Logo" className={styles.uLogo} />
          </div>
        </div>
      </section>
        ...
        <div className={styles.filterSection}>
          ...
          <div className={styles.categoryFilters}>
            {categories.map((category) => (
              <button
                key={category}
                className={`${styles.categoryBtn} ${selectedCategory === category.toLowerCase() ? styles.active : ''}`}
            ...
            filteredEquipment.map((item) => (
              ...
              >
                ...
                <div className={styles.equipmentInfo}>
                  ...
                  <span className={`${styles.equipmentStatus} ${item.status === 'AVAILABLE' ? styles.available : styles.inUse}`}>
