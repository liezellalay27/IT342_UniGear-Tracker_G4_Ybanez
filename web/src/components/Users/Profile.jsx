  ...
  if (loading) {
    return (
      <div className={styles['loading-wrapper']}>
        <LoadingSpinner message="Loading profile..." showTimer={false} />
      </div>
    );
  }
      ...
      <header className={styles['homepage-header']}>
        <div className={styles['header-content']}>
          ...
          <div className={styles['nav-links']}>
            <button onClick={() => navigate('/dashboard')} className={styles['nav-link']}>Dashboard</button>
            {profile.role === 'ADMIN' ? (
              <>
            ...
            <button onClick={() => navigate('/profile')} className={`${styles['nav-link']} ${styles.active}`}>Profile</button>
